...
const uploadImages = (buffData, type) => {
    return new Promise(async (resolve, reject) => {
        ...
        const filePath = 'storage/random/trash.' + ext
...
const banner = cfonts.render(('MiKako|Taufik - Kun'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
...
module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close, uploadImages}
